...
public class JCustomSatConfigPanel extends javax.swing.JPanel {
	...
	private static final long serialVersionUID = 4345723217101677937L;
	...
	public void addNode2MissionDesigner(CustomTreeTableNode node) {
		...
		// special case -- inserting an EVENT node
	...
	private void initComponents() {
		...
		addManeuverButton = new javax.swing.JButton();
		...
		satNameTextField.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
		satNameTextField.setText("New Satellite");
		...
		addEventButton.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/icons/customSatIcons/event.png"))); // NOI18N
		addEventButton.setToolTipText("Add event node");
		...
		addManeuverButton.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/icons/customSatIcons/burn.png"))); // NOI18N
		addManeuverButton.setToolTipText("Add maneuver node");
		addManeuverButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						addManeuverButtonActionPerformed(evt);
					}
				});
	...
	private void addManeuverButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addManeuverButtonActionPerformed
		addNode2MissionDesigner(new ManeuverNode(null, sat));
	}// GEN-LAST:event_addManeuverButtonActionPerformed
	...
	private void addEventButtonActionPerformed(java.awt.event.ActionEvent evt)// GEN-FIRST:event_addBurnButtonActionPerformed
	...
	{// GEN-HEADEREND:event_upNodeButtonActionPerformed
		...
		// selected
		{
			...
			if (selectedNode != ((CustomTreeTableNode) treeTableModel.getRoot())
					...
					&& !selectedNode.getNodeType().equalsIgnoreCase("Maneuver")) {
				// get parent of selected object
				CustomTreeTableNode selectedNodeParent = (CustomTreeTableNode) missionDesignJXTreeTable
						.getTreeSelectionModel().getSelectionPath()
						.getParentPath().getLastPathComponent();
	...
	// private void addInitialConditionNodeActionPerformed(
	// java.awt.event.ActionEvent evt)//
	// GEN-FIRST:event_addFromFileButton1ActionPerformed
	...
	private javax.swing.JButton addManeuverButton;
