...
public class JSatBrowserInternalFrame extends javax.swing.JInternalFrame {
	...
	// data loader
	SatBrowserTleDataLoader sbtdl; // For now custom TLE data loaded just loads
									// for the current broswer, after it is
									// closed, a new browser won't have the data
	...
	private void createCustomSatMenuItemActionPerformed(
			java.awt.event.ActionEvent evt)// GEN-FIRST:event_createCustomSatMenuItemActionPerformed
